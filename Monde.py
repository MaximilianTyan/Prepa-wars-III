...
class Monde():
    ...
    def clicEntre(self):
        ...
        NPC = self.NPCs.get(self.get_case(self.vect), None)
        if NPC != None:
            self.Dialogue.addDialogue(NPC.idleDialog, NPC.function)
...
class Dialogue():
    ...
    def iniDialogue(self, objDict):
        ...
        self.textZone = pyglet.text.Label(text='Default',
                                        ...
                                        multiline=True)
        self.textBackGround = pyglet.image.load('resources/images/monde/dialogueBox.png')
